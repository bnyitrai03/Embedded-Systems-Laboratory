...
#define JIWY_YAW_TAU_D 0.0
#define JIWY_YAW_BETA 0.0
#define JIWY_YAW_TAU_I 1000000000.0
#define JIWY_YAW_OUTPUT_MIN -0.30
#define JIWY_YAW_OUTPUT_MAX 0.30

#define JIWY_PITCH_CORR_GAIN 0.0
#define JIWY_PITCH_KP 0.20
#define JIWY_PITCH_TAU_D 0.0
#define JIWY_PITCH_BETA 0.0
#define JIWY_PITCH_TAU_I 1000000000.0
#define JIWY_PITCH_OUTPUT_MIN -0.30
#define JIWY_PITCH_OUTPUT_MAX 0.30
