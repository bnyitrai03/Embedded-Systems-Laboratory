...
int main(int argc, char *argv[])
{
    ...
    pipeline = gst_pipeline_new("green-ball-mac-headless");
    ...
    if (!gst_element_link_many(source, convert, scale, capsfilter, sink, NULL)) {
    ...
    g_print("mac headless | camera index: %s\n", camera_index);
