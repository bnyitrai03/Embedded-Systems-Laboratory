...
## IP details
##  
set_module_property DESCRIPTION "ESL PWM (Avalon-MM slave port)"
...
set_module_property TOP_LEVEL_HDL_FILE PWM_wrapper.v
set_module_property TOP_LEVEL_HDL_MODULE PWM_wrapper
...
##  
add_file PWM_wrapper.v {SYNTHESIS SIMULATION}
...
add_interface ina conduit end
add_interface_port ina INA export Output 1

add_interface inb conduit end
add_interface_port inb INB export Output 1

add_interface pwm_c conduit end
add_interface_port pwm_c C export Output 1
...
proc elaborate_me {}  {
  ...
  set_port_property INA WIDTH 1
  set_port_property INB WIDTH 1
  set_port_property C WIDTH 1
